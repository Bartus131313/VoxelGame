...
/** @brief Handles keyboard state tracking, key history transitions, and key callback routing. */
class KeyboardManager {
public:
    KeyboardManager() = default;

    /**
     * @brief Initializes the Keyboard Manager and attaches callbacks to the GLFW window.
     *
    ...
    /**
     * @brief Updates previous key states for single-frame trigger queries.
     *
    ...
    /**
     * @brief Checks whether a specific keyboard key is currently held down.
     *
    ...
    /**
     * @brief Checks whether a specific keyboard key was pressed during the current frame.
     *
     * @param key GLFW key code constant (e.g., @c GLFW_KEY_W, @c GLFW_KEY_SPACE).
     *
    ...
    /**
     * @brief Checks whether a specific keyboard key was released during the current frame.
     *
     * @param key GLFW key code constant (e.g., @c GLFW_KEY_W, @c GLFW_KEY_SPACE).
     *
