...
/** @brief Represents 2D element that will be rendered on UI. */
class UIElement {
public:
    virtual ~UIElement() = default;

    /**
     * @brief Updates the UI Element, called on update pass.
     *
    ...
    /**
     * @brief Renders the whole UI Element, called on render pass.
     *
    ...
    /**
     * @brief Sets position of UI Element to given one.
     *
    ...
    /**
     * @brief Sets scale of UI Element to new one.
     *
    ...
    /**
     * @brief Sets rotation of UI Element to new one.
     *
    ...
    /**
     * @brief Set element's visibility to new one.
     *
    ...
    /**
     * @brief Set element's z-index to new one.
     *
    ...
    /**
     * @brief Checks if UI Element is visible and should be rendered.
     *
